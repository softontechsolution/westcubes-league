    ...
    const fetchStandings = async () => {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/standings/`,
        );
        if (response.ok) {
      ...
      <div className="flex justify-between items-end mb-6">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Westcubes Premier Football League
          </p>
        </div>
      </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-800/50 text-gray-400 text-sm uppercase tracking-wider border-b border-gray-700">
                  ...
                  <th className="p-4 font-semibold text-center" title="Won">
                    W
                  </th>
                  <th className="p-4 font-semibold text-center" title="Drawn">
                    D
                  </th>
                  <th className="p-4 font-semibold text-center" title="Lost">
                    L
                  </th>
                  <th
                    className="p-4 font-semibold text-center hidden sm:table-cell"
                    title="Goals For"
                  >
                    GF
                  </th>
                  ...
                  <th
                    className="p-4 font-bold text-brand text-center text-lg"
                    title="Points"
                  >
                    Pts
                  </th>
